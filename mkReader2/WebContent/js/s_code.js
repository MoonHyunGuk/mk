...
function setEvent(event_no) {
	s.linkTrackVars="events";
	s.linkTrackEvents=event_no;
	s.events=event_no;
	s.tl(true,'o',event_no);
}

var s_account="hccjejuolle-dev"   // Report Suite ID
...
s.linkInternalFilters="javascript:,jejuolle.org,localhost"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"

/* Page Name Plugin Config */
s.siteID="olle"            // leftmost value in pagename
s.defaultPage=""       // filename to add when none exists
s.queryVarsList="cs_no,bs_no,GROUP_NO,fr_year,fr_month,fr_day,BOARD_NO,join_type"     // query parameters to keep
...
/* Plugin :  timeparting */
	s.prop1=s.getTimeParting('h','+9','','0');
	s.prop2=s.getTimeParting('d','+9','','0');
...
/* set login event */
if (s.getQueryParam('login')=="ok") { s.events="event2"; }
...
s.visitorNamespace="hyundaicard"
s.dc=112
