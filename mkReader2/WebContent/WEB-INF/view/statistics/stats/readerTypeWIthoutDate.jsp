...
function fn_searchList() {
	...
	var opEndDate = document.getElementById("opEndDate").value;
	...
	<form method="post" name="fm" id="fm">
		<div style="overflow: hidden; padding-left: 5px;  width: 410px">
			<div class="box_gray_left" style="padding: 10px 0; width: 400px">
				<b>확장일</b>&nbsp;&nbsp;
				<input type="text" name="opStartDate" id="opStartDate" value="${opStartDate }"  style="width: 80px; vertical-align: middle; padding: 0;" maxlength="8" onkeypress="cf_checkNumeric();">&nbsp;~&nbsp;
				<input type="text" name="opEndDate" id="opEndDate" value="${opEndDate }"  style="width: 80px; vertical-align: middle; padding: 0;" maxlength="8">
				&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
				<a href="#fakeUrl" onclick="fn_searchList();"><img src="/images/bt_joh.gif" style="border: 0; vertical-align: middle;"></a>
			</div>
		</div>
	</form>
	<div style="text-align: right; color: red; width: 410px; padding-top: 3px">※2014년 1월 1일을 검색시 -&gt; 20140101&nbsp;</div>
