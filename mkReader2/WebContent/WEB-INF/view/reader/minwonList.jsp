...
<script type="text/javascript">
	...
	function moveTo(where, seq) {
		...
		$("pageNo").value = seq;
		minwonListForm.target = "_self";
		minwonListForm.action = "/reader/minwon/retrieveMinwonList.do";
	...
	function saveMinwon(type){
		...
		minwonListForm.target = "_self";
		minwonListForm.action = "/reader/minwon/saveMinwon.do";
		minwonListForm.submit();
		return;
	}
	...
	function deleteMinwon(){
		...
		if(confirm("등록된 민원을 삭제 하시겠습니까?")){
			...
			minwonListForm.target = "_self";
			minwonListForm.action = "/reader/minwon/deleteMinwon.do";
			minwonListForm.submit();
		}
		return;
	}
	...
	function validation(){
		...
		if($("minwonDesc").value.length > 250){
	...
	function print(){
		...
		window.open('','ozMinwonList','width=1000, height=800, toolbar=no, menubar=no, location=no, status=no, resizable=1, scrollbars=no');
	
		minwonListForm.target = "ozMinwonList";
		minwonListForm.action = actUrl;
		minwonListForm.submit();
	}
	...
	function printMinwonDetail(){
		...
		window.open('','ozMinwonDetail','width=1000, height=800, toolbar=no, menubar=no, location=no, status=no, resizable=1, scrollbars=no');
	
		minwonListForm.target = "ozMinwonDetail";
		minwonListForm.action = actUrl2;
		minwonListForm.submit();
	}
	...
	function setMinwonCd2(jsonObjArr){
		...
		for( i=0 ; i < jsonObjArr.minwonCd2List.length; i++){
...
<div class="box_white" style="padding: 10px 0;  width: 1020px; margin: 0 auto;">
	...
	&nbsp;&nbsp;
	<a href="#fakeUrl" onclick="print();"><img src="/images/bt_print.gif" style="vertical-align: middle; border: 0;" alt="출력"></a>
</div>
<!-- //search conditions -->
<!-- 민원등록 및 상세 -->
		...
		<tr>
			...
			<td>
			    ...
			    <div style="position:absolute;" id="jikukNamePopup" >
			        <table id="jikukNameTable"  style="background-color: #fffafa" border="0">
...
<div class="box_list" style="width: 1020px; margin: 0 auto;">
	<!-- count -->
	<div style="padding-bottom: 5px"><b>◆ 조회 건수 / 총 민원 : <c:out value="${minwonCnt}"/>건 / <c:out value="${totalCnt}"/>건</b></div>
	<!-- //count -->
