		...
		<div style="width: 610px; float: left; border: 0px solid green; padding-right: 10px;">
			...
			<!-- 독자정보 -->
				...
				<table class="tb_edit_4" style="width: 100%;">
					...
					<tr>
						<th>변경전주소</th>
						<td colspan="5" style="text-align: left; height:20px; font-size: 13px" id="oldAddr"></td>
					</tr>
					 <tr>
					    <th style="letter-spacing: -1px"><b class="b03">*</b>도로명주소</th>
						<td style="text-align: left;">
			...
			<div style="width: 400px; border: 0px solid yellow; float: left;">
				...
				<div style="padding: 4px 0 2px 0; width: 400px;">
					<div class="box_white" style="width: 391px; overflow: hidden; padding: 3px; "> 
						...
						<div style="width: 333px; text-align: left; float: left; padding: 3px 0;"><textarea id="remk" name="remk" style="height:84px; width:328px;" rows="" cols=""></textarea></div>
						<div style="width: 58px; float: left; padding-top: 3px; font-weight: bold; cursor: pointer; vertical-align: bottom;">
							<div style="border: 1px solid #a4a7ac; background-color: #e5e5e5; padding: 28px 0; color: blue" onclick="fn_saveRemk();">비고<br/>저장</div>
				...
				<!-- //bottom -->
				<!-- form -->
				<div><textarea id="desc" name="desc" rows="" cols="" readonly="readonly" style="border: 1px solid #c0c0c0; width: 397px; height: 85px"></textarea></div>
				<!-- //form -->
			</div>
		</div>
		<!-- 상세리스트(월별수금내역)-->
