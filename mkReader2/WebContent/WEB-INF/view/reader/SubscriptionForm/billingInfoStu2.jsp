...
<script type="text/javascript">
	...
	function useClauses(){
		...
		billingForm.action="/reader/subscriptionForm/useClauses2.do";
		billingForm.submit();
				...
				<table align="center" cellpadding="0" cellspacing="0" width="605">
					...
					<tr>
						...
						<tr>
							...
							<center><a href="/reader/subscriptionForm/stuBillingEdit.do"><img src="/images/auto.gif" width="157" height="23" border="0"></a> &nbsp;&nbsp; 
