...
<script type="text/javascript">
	...
	function search() {
		...
		billingForm.action="/reader/subscriptionForm/searchBillInfo.do";
		billingForm.submit();
	}
	//이용 약관
	function useClauses(){
			...
			<tr>
				...
				<table align="center" cellpadding="0" cellspacing="0" width="605">
					...
					<tr>
						...
						<p align="center"><a href="/reader/subscriptionForm/billingEdit.do"><img src="/images/auto.gif" width="157" height="23" border="0"></a></p>
						</td>
					</tr>
				</table>
				   </p>
