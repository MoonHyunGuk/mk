...
<!--
	function check() {
		...
		frmParent.action="/reader/subscriptionForm/billingEdit.do";
		frmParent.submit();
	}
//-->
</script>
...
본 신청과 관련하여 본인은 다음 금융거래정보(거래은행명, 지점명, 계좌번호)를 출금이체를 신규 신청하는 때로부터 해지 신청할 때까지 상기 수납기관에 제공하는 것에 대하여 「금융실명거래 및 비밀보장에 관한 법률」의 규정에 따라 동의 합니다.
						...
						<div style="text-align:center; width:100%; padding-top:10px"><a href="javascript:check();"><img src="/images/bt_apply_mkapply.gif" alt="구독신청"></a></div>
