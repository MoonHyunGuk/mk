...
<script type="text/javascript">
	...
	function search() {
		...
		billingForm.action="/reader/subscriptionForm/searchBillInfoStu2.do";
		billingForm.submit();
	}
	//이용 약관
	function useClauses(){
		billingForm.target="_self";
		billingForm.action="/reader/subscriptionForm/stuUseClauses2.do";
		billingForm.submit();
...
<table cellpadding="0" cellspacing="0" width="676" height="100%">
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="676">
			<tr>
				<td width="149">
				<p><a href="/reader/subscriptionForm/stuBillingEdit2.do"><img src="/images/m1.gif" width="149" height="35" border=0 onMouseOver='this.src="/images/m1_ov.gif"' onMOuseOut='this.src="/images/m1.gif"'></a></p>
				</td>
				<td width="149">
			...
			<tr>
				...
				<table align="center" cellpadding="0" cellspacing="0" width="605">
					...
					<tr>
						...
						<p align="center"><a href="/reader/subscriptionForm/stuBillingEdit2.do"><img src="/images/auto.gif" width="157" height="23" border="0"></a></p>
						</td>
					</tr>
				</table>
				   </p>
