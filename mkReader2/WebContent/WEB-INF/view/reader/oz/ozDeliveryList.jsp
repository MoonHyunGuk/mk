...
<html>
    ...
    <body topmargin="0" leftmargin="0" style="text-align: center;">
           ...
           <object id="ozviewer"  CLASSID="CLSID:0DEF32F8-170F-46f8-B1FF-4BF7443F5F25"  width="100%"   height="100%">
            ...
            <param name="connection.reportname" value="/reader/<c:out value="${type}"/>.ozr">
            <param name="viewer.configmode" value="html">
            <param name="viewer.isframe" value="false">
            <param name="viewer.namespace" value= "<%= ISiteConstant.OZ_VIEWER_NAME %>" >
            <param name="odi.odinames" value="deliveryList">
            <param name="odi.deliveryList.pcount" value="3">
            <param name="odi.deliveryList.args1" value="userId='<c:out value="${userId}"/>'">
            <param name="odi.deliveryList.args2" value="guyukSql=<c:out value="${guyukSql}"/>">
            <param name="odi.deliveryList.args3" value="newsCd=<c:out value="${newsCd}"/>">
