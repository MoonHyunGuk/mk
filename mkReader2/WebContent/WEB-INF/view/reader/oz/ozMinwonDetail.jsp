...
<html>
    ...
    <script type="text/javascript" for="ozviewer" event="OZPrintCommand(msg, code, reportname, printername, printcopy, printedpage, printrange, username)">
		if(code == "0"){
			opener.saveMinwon(2);
		}
	</script>
	...
	<object id="ozviewer"  CLASSID="CLSID:0DEF32F8-170F-46f8-B1FF-4BF7443F5F25"  width="100%"   height="100%">
		...
		<param name="connection.reportname" value="/reader/minwonDetail.ozr">
		<param name="viewer.configmode" value="html">
		<param name="viewer.isframe" value="false">
		<param name="viewer.printcommand" value="true">
		<param name="viewer.namespace" value= "<%= ISiteConstant.OZ_VIEWER_NAME %>" >
		<param name="odi.odinames" value="minwonDetail">
		<param name="odi.minwonDetail.pcount" value="2">
		<param name="odi.minwonDetail.args1" value="minwonDt=<c:out value="${minwonDt}"/>">
		<param name="odi.minwonDetail.args2" value="minwonNo=<c:out value="${minwonNo}"/>">
		<param name="odi.minwonDetail.clientdmtype" value="Memory">
		<param name="odi.minwonDetail.serverdmtype" value="Memory">
		<param name="odi.minwonDetail.fetchtype" value="Concurrent">
	</object>
