...
.tdbd {
  ...
  BORDER-BOTTOM: black 1px solid;
	...
	<table cellpadding=3 cellspacing=1 border=0 width=550 bgcolor=#fff>
		<tr>
			<td align="center" height="20" colspan="6"><b>자동이체 리스트</b></td>
		</tr>
	</table>
	<p style="top-margin:10px;">
	<table cellpadding=3 cellspacing=1 border=0 width=550 bgcolor=#fff>
		<tr>
			<td align="center" colspan="6"><b>[</b> ${fn:substring(fromDate,0,4 ) }년 ${fn:substring(fromDate,5,7 ) }월 ${fn:substring(fromDate,8,10 ) }일  ~ ${fn:substring(toDate,0,4 ) }년 ${fn:substring(toDate,5,7 ) }월 ${fn:substring(toDate,8,10 ) }일 <b>]</b></td>
		</tr>
	</table>
	<p style="top-margin:10px;">
