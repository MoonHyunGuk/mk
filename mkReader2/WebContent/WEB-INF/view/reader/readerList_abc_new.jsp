...
<script type="text/javascript">
	...
	function detailView(index) {
		...
		$("orgChgDt").value = document.getElementById('tem_chgDt'+index).innerHTML;
	...
	<div style="width: 1020px; margin: 0 auto; overflow: hidden; border: 0px solid red; padding-bottom: 5px">
		...
		<div style="width: 610px; float: left; border: 0px solid green; padding-right: 10px;">
			...
			<div style="width: 400px; border: 0px solid yellow; float: left;">
				...
				<div style="float: left; width: 252px; border: 0px solid red; padding-top: 20px">
				...
				<!-- //billing list -->
				<!-- button -->
				<div style="padding: 24px 0 2px 0; width: 400px;">
					<div class="box_white" style="width: 391px; overflow: hidden; padding: 3px;"> 
						<div style="text-align: left; padding: 5px 0 5px 5px; width: 250px;  border: 0px solid red; float: left;">
							<c:choose>
						...
						<div style="padding: 5px 0 0 0; text-align: right; border: 0px solid red; float: left; width: 130px">
							<c:choose>
								<c:when test="${not empty admin_userid }">
									<!-- 
