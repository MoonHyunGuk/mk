...
<script type="text/javascript">
	...
	function popExtendReader(gbn){
		var sgBgmm = document.getElementById("sgBgmm").value;
		...
		readerListForm.action = "/reader/readerManage/popExtendReader.do?gbn="+gbn+"&sgBgmm="+sgBgmm;
		readerListForm.submit();
	}
	//추가 구독
	function extendReader(){
		/*
		alert(document.getElementById("hjDt").value);
		alert(document.getElementById("sgBgmm").value);
		alert(document.getElementById("hjDt2").value);
		*/
		readerListForm.target = "_self";
		readerListForm.action = "/reader/readerManage/extendReaderForABC.do";
		readerListForm.submit();
	}
...
<!--독자등록-->
	<div style="width: 1020px; margin: 0 auto; overflow: hidden; border: 0px solid red; padding-bottom: 5px">
		...
		<div style="width: 610px; float: left; border: 0px solid green; padding-right: 10px;">
			...
			<!-- //독자정보&구독정보 -->			
			<!-- 월별수금내역 -->
			<div style="width: 400px; border: 0px solid yellow; float: left; padding-top: 25px;">
				<!-- top selector -->
