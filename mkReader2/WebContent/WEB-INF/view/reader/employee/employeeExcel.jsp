...
.tdbd {
  ...
  BORDER-BOTTOM: black 1px solid;
	...
	<table cellpadding=3 cellspacing=1 border=0 width=550 bgcolor=#fff>
		<tr>
			<td align="center" height="20" colspan="10"><b>본사 직원 리스트</b></td>
		</tr>
	</table>
	<p style="top-margin:10px;">
	<table cellpadding=3 cellspacing=1 border=1 width=550 bgcolor=#fff>
		<tr class=bg_gray>
			<td  align="center"><font class="b02">관리지국</font></td>
			<td  align="center"><font class="b02">회사명</font></td>
			<td  align="center"><font class="b02">부서명</font></td>
			<td  align="center"><font class="b02">사번</font></td>
			<td  align="center"><font class="b02">성명</font></td>
			<td  width="25%" align="center"><font class="b02">주소</font></td>
			<td  align="center"><font class="b02">휴대폰</font></td>
			<td  align="center"><font class="b02">금액</font></td>
			<td  align="center"><font class="b02">신청일<br/>(해지일)</font></td>
			<td  align="center"><font class="b02">현재상태</font></td>
		</tr>
		<c:choose>
			...
			<c:otherwise>
				<c:forEach items="${employeeList }" var="list">
					<tr>
						...
						<Td align="center">${list.COMPANYNM }</Td>
						<Td align="center">${list.OFFINM }</Td>
						<Td align="center">${list.SABUN }</Td>
						...
						<c:choose>
							<c:when test="${list.BNO eq '999' }">
								<Td align="center">${list.INDT }<br/>(<font style="color:#e74985;">${list.STDT }</font>)</Td>
