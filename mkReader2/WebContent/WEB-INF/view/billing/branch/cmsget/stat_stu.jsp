...
<div><span class="subTitle">이체내역조회(학생독자)</span></div>
...
<div class="box_white" style="padding: 10px 0; width: 1020px; margin: 0 auto;">
	...
	&nbsp;
	<input type="text" class="box_100" size="10" name="sdate" value="<c:out value='${sdate}' />" readonly onclick="Calendar(this)" style="vertical-align: middle; width: 85px;">&nbsp;~&nbsp; 
	<input type="text" class="box_100" size="10" name="edate" value="<c:out value='${edate}' />" readonly onclick="Calendar(this)" style="vertical-align: middle; width: 85px;">&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<c:otherwise>
				<c:forEach items="${resultList}" var="list" varStatus="status">
					<tr bgcolor="ffffff" align="center">
						...
						<td ><c:out value="${list.CODENUM}" /><!-- ABC 수정(2012.05.16: 박윤철 CODENUM -> READNO) --></td>
