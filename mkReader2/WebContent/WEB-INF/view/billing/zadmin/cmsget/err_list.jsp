...
<div><span class="subTitle">미수독자조회(일반)</span></div>
<form name="formList" method="post">
<input type="hidden" name="cmsdate" value="${cmsdate}" />
<!-- list -->
<div style="width: 1020px; margin: 0 auto; padding-top: 5px;">
	...
	<div style="width: 1020px; text-align: right; padding-top: 10px"><img src="/images/bt_exel.gif" onclick="window.open('./err_list_excel.do','_self');" style="cursor:pointer;"/></div>
</div>
<!-- //list -->
</form>		
