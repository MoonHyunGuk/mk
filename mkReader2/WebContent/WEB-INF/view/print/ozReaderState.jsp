...
<html>
    ...
    <body topmargin="0" leftmargin="0">
           ...
           <object id="ozviewer"  CLASSID="CLSID:0DEF32F8-170F-46f8-B1FF-4BF7443F5F25"  width="100%"   height="100%">
            ...
            <param name="connection.reportname" value="/print/readerState<c:out value="${gubun}"/>.ozr">
            <param name="viewer.configmode" value="html">
            <param name="viewer.isframe" value="false">
            <param name="viewer.namespace" value= "<%= ISiteConstant.OZ_VIEWER_NAME %>" >
            <param name="odi.odinames" value="readerState">
            <param name="odi.readerState.pcount" value="3">
            <param name="odi.readerState.args1" value="newsCd=<c:out value="${newsCd}"/>">
            <param name="odi.readerState.args2" value="gubun=<c:out value="${gubun}"/>">
            <param name="odi.readerState.args3" value="boseq='<c:out value="${boseq}"/>'">
            <param name="odi.readerState.clientdmtype" value="Memory">
            <param name="odi.readerState.serverdmtype" value="Memory">
            <param name="odi.readerState.fetchtype" value="Concurrent">
        </object>
