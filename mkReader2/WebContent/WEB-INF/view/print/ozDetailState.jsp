...
<html>
    ...
    <body topmargin="0" leftmargin="0">
           ...
           <object id="ozviewer"  CLASSID="CLSID:0DEF32F8-170F-46f8-B1FF-4BF7443F5F25"  width="100%"   height="100%">
            ...
            <param name="connection.reportname" value="/print/detailState.ozr">
            <param name="viewer.configmode" value="html">
            <param name="viewer.isframe" value="false">
            <param name="viewer.namespace" value= "<%= ISiteConstant.OZ_VIEWER_NAME %>" >
            <param name="odi.odinames" value="detailState">
            <param name="odi.detailState.pcount" value="8">
            <param name="odi.detailState.args1" value="fromYymmdd=<c:out value="${fromYymmdd}"/>">
            <param name="odi.detailState.args2" value="toYymmdd=<c:out value="${toYymmdd}"/>">
            <param name="odi.detailState.args3" value="fromGno=<c:out value="${fromGno}"/>">
            <param name="odi.detailState.args4" value="toGno=<c:out value="${toGno}"/>">
            <param name="odi.detailState.args5" value="gubun=<c:out value="${gubun}"/>">
            <param name="odi.detailState.args6" value="newsCd=<c:out value="${newsCd}"/>">
            <param name="odi.detailState.args7" value="boseq='<c:out value="${boseq}"/>'">
            <param name="odi.detailState.args8" value="dateGubun=<c:out value="${dateGubun}"/>">
            <param name="odi.detailState.clientdmtype" value="Memory">
            <param name="odi.detailState.serverdmtype" value="Memory">
            <param name="odi.detailState.fetchtype" value="Concurrent">
        </object>
