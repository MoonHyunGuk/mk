...
jQuery(function(){
	...
	jQuery("#search_btn").click(function(){
		jQuery("#search").attr("action","./jidaeSendSms.do").submit();
	...
	jQuery("#sendMail_btn").click(function(){
		...
		jQuery("#sendForm").attr("action","./excuteSendSms.do").submit();
		jQuery("#prcssDiv").show();
		return false;
	});
});
...
<div style="padding-bottom: 5px;"><span class="subTitle">지대통보서 SMS전송</span></div>
	...
	<tr>
		<td colspan="8" style="border:0;">
			<div style="float: right;">
				...
				<span class="btnCss2"><a class="lk2" href="#" id="sendMail_btn">SMS전송</a></span>
			</div>
		</td>
	</tr>
</table>
...
<div>	
	...
	<div id="xlist" style="padding-left:14px;width:1020px;">
		<table class="tb_list_a" width="100%">
			...
			<tr>
				<td><input type="checkbox" id="boSeq${i.index}" name="boSeq${i.index}" value="${list.BOSEQCODE}" <c:if test="${list.ISHANDY == 'N'}">disabled="disabled"</c:if>/></td>
