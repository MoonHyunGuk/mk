...
function doPrint(){
	 if(!validation()){
		...
		actUrl = "/output/billOutput/ozGiroViewer.do";
		window.open('','ozGiroBill','width=1000, height=800, toolbar=no, menubar=no, location=no, status=no, resizable=1, scrollbars=no');

		frmInfo.target = "ozGiroBill";
...
<div><span class="subTitle">지로영수증</span></div>
<form id= "frmInfo" name = "frmInfo" method="post">
<!--인쇄조건-->
<c:if test="${('1' eq jikyungYn) }">
	<div style="text-align: right; width: 1020px; padding-bottom: 5px;">
		<font class="b02">
			<input type="radio" id="jikyung" name="jikyung" value="1" checked style="border: 0; vertical-align: middle;" /> 직영지로번호&nbsp;&nbsp;
			<input type="radio" id="jikyung" name="jikyung" value="2" style="border: 0; vertical-align: middle;" /> 지국지로번호
		</font>
	</div>
</c:if>
<!-- search conditions -->
	...
	<table class="tb_search" style="width: 1020px;">
		...
		<tr>
			...
			<td style="text-align: left; padding-left: 10px;">
				<select name="prtCb"   id="prtCb"  style="width: 100px; vertical-align: middle;" onchange="changePrt()" >
					<option value ='${prtCb.AA}'  selected>${prtCb.BA}월분</option>
			 		<option value ='${prtCb.AB}' >${prtCb.BB}월분 마감전인쇄</option>
			  	</select>&nbsp;&nbsp;&nbsp;
				<font class="b02"><input type="checkbox" id="subs" name="subs" value="1" style="border: 0; vertical-align: middle;"/> 신문명인쇄</font> 
			</td>
			<th>미수인쇄여부</th>
			<td>
				<input type="radio"  name="misuPrt"  value="0"  onclick="changeMisu()" style="border: 0; vertical-align: middle;" checked /> 미수포함&nbsp;
				<input type="radio"  name="misuPrt"  value="1"   onclick="changeMisu()" style="border: 0; vertical-align: middle;" /> 미수제외
			</td>
			<th>미수개월수</th>
			<td style="text-align: left; padding-left: 10px;">
				<select id="month" name="month"  style="width: 70px; vertical-align: middle;">
				...
				<font class="b02"><input type="checkbox" id="misuOnly" name="misuOnly" value="1" style="vertical-align: middle; border: 0;"/> 미수만인쇄</font>  
			</td>
		</tr>
		<tr>
			<th>고객안내문</th>
			<td style="text-align: left; padding-left: 10px;">
			    ...
			    <a href="#fakeUrl" onclick="popCustNoti()"><img src="/images/bt_view.gif" style="vertical-align: middle;border: 0"></a>
			</td>
			<th>미수통합</th>
			<td>
				<input type="radio"   name="misuSum"  value= "0" checked style="vertical-align: middle; border: 0;"> 통합인쇄&nbsp;
				<input type="radio"   name="misuSum"  value="1" style="vertical-align: middle; border: 0;"> 월별인쇄
			</td>
			<th>프린터모델</th>
			<td style="text-align: left; padding-left: 10px;">
			    ...
			    <input type=hidden id="prtCbAB" name="prtCbAB" value="${prtCb.AB}" />
...
<!-- //search conditions -->
<!-- check conditons -->
<div style="overflow: hidden; padding-top: 15px; width: 1020px; margin: 0 auto; ">
	<!-- left -->
	<div style="float: left; width: 510px; padding-right: 10px; border: 0px solid">
		...
		<div style="overflow: hidden; padding: 10px 0 0 0px; border: 0px solid; width: 510px;">
			<!-- left -->
			<div style="float: left; padding-right: 10px; border: 0px solid; width: 230px">
				<table class="tb_list_a" style="width: 230px;">
					...
					<c:if test="${('521050' eq userId) }">
						<tr>
							<td><input type="checkbox" id="reader2" name="reader2" value='015' style="border: 0;"/></td>
							<td>015</td>
							<td>교육</td>
						</tr>
					</c:if>																					
			...
			<div style="float: left;">
				<table class="tb_list_a" style="width: 270px;">
					...
					<tr>
						<td><input type="checkbox" id="allSugm" name="allSugm" onclick="checkBoxCtr('allSugm','sugm');" style="border: 0;"/></td>
						<td>코드</td>
						<td>수금방법</td>
						<td>약어</td>
					</tr>
					...
					<tr>
						<td><input type="checkbox" id="sugm0" name="sugm0" value='011' checked style="border: 0;"/></td>
						<td>011</td>
						<td>지로</td>
						<td>G</td>
					</tr>
					<tr>
						<td><input type="checkbox" id="sugm1" name="sugm1" value='012' style="border: 0;"/></td>
						<td>012</td>
						<td>방문</td>
						<td>B</td>
					</tr>		
