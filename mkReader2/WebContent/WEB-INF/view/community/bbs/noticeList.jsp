...
<!-- title -->
<div><span class="subTitle">공지사항</span></div>
<!-- //title -->
...
<div class="box_gray" style="padding: 10px 0; width: 1020px;">
	...
	<input type="text" id="search_key" name="search_key" value="${search_key}" onkeypress="if(event.keyCode==13){moveTo('list','1');}" style="width: 150px; vertical-align: middle;">&nbsp; 
	<a href="#fakeUrl" onclick="moveTo('list','1');"><img src="/images/bt_search.gif" style="border: 0; vertical-align: middle;"></a>
</div>
<!-- //search conditions -->
</form>
<!-- list -->
<div class="box_list" style="width: 1020px; margin: 0 auto;">
	<table class="tb_list_a_5" style="width: 1020px;">
				...
				<c:forEach items="${resultList}" var="list" varStatus="status">
					<tr>
						...
						<td style="text-align: left;">
							<div style="padding-left: 10px;"><font class="s_menu"><a href="#fakeUrl" onclick="noticeView('${list.SEQ}')">${list.TITL }</a></font></div>
						</td>
						<td>
							<c:choose>
		...
		<%
			if ("9".equals(userGb) ){
		%>
			<div style="width: 1020px; text-align: right;"><a href="#fakeUrl" onclick="form('write');"><img src="/images/bt_insert.gif" style="border: 0; vertical-align: middle;"></a>&nbsp;</div>		 						 		
		<%
			}
		%>
