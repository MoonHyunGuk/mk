...
public class CmsrequestController extends MultiActionController implements
	 ...
	 * @throws Exception
	 */
	public ModelAndView index13_stu(HttpServletRequest request,
		...
		// excute query
		List resultList = generalDAO.queryForList("billing.student.cmsrequest.getEB13LogList", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEB13LogList");
		
		int t_count = (Integer) generalDAO.queryForObject("billing.student.cmsrequest.getEB13LogCount");
		logger.debug("===== billing.student.cmsrequest.getEB13LogCount");
		
		// mav
		ModelAndView mav = new ModelAndView();
		mav.setViewName("billing/student/cmsrequest/index13_stu");
	 ...
	 * @throws Exception
	 */
	public ModelAndView view13_stu(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		...
		Map resultMap = (Map) generalDAO.queryForObject("billing.student.cmsrequest.getEB13LogInfo", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEB13LogInfo");

		// mav
		ModelAndView mav = new ModelAndView();
		mav.setViewName("billing/student/cmsrequest/view13_stu");
		mav.addObject("now_menu", MENU_CODE_BILLING_STU);
	 ...
	 * @throws Exception
	 */
	public ModelAndView err13_stu(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		...
		if ( resultMap != null ) {
			...
			if ( StringUtils.isNotEmpty(err_str)) {
				...
				for ( int i = 0; i < errArr.length; i++ ) {
					...
					String numidTmp = "00000" + num.trim();
		...
		// mav
		ModelAndView mav = new ModelAndView();
		mav.setViewName("billing/student/cmsrequest/err13_stu");
		mav.addObject("now_menu", MENU_CODE_BILLING_STU);
		mav.addObject("show_hidden5", "display");
	 ...
	 * @throws Exception
	 */
	public ModelAndView process13b_stu(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		
		int pagesize = 40;
		int conternp = 10;
		//String idid = "tbl_cmsEA14data_log_stu";
		String thisorder = "";
		String orderby = "";
		...
		Map existMap = (Map) generalDAO.queryForObject("billing.student.cmsrequest.getExistEB13Log", dbparam);
		logger.debug("===== billing.student.cmsrequest.getExistEB13Log");
		
		if ( existMap != null ) {	// 오늘 생성된 파일이 없을 때 생성가능.
			mav.setViewName("common/message");
			mav.addObject("message", "오늘 날짜의 데이타가 존재합니다 하루에 한건만 입력이 가능합니다.");
			mav.addObject("returnURL", "/billing/student/cmsrequest/index13_stu.do");
			return mav;
		}
		else {
			...
			try {
				...
				generalDAO.getSqlMapClient().update("billing.student.cmsrequest.updateUsersStatus", dbparam);
				logger.debug("===== billing.student.cmsrequest.updateUsersStatus");
				...
				List resultList = generalDAO.getSqlMapClient().queryForList("billing.student.cmsrequest.getUserList", dbparam);
				logger.debug("===== billing.student.cmsrequest.getUserList");
					...
					while ( iter.hasNext() ) {
						...
						if ( StringUtils.isEmpty(err_13_str)) {
							...
							if ( temp_str.length() != 120 ) {
								...
								dbparam.put("numid", numid);
								generalDAO.getSqlMapClient().update("billing.student.cmsrequest.updateUsersStatus2", dbparam);
								logger.debug("===== billing.student.cmsrequest.updateUsersStatus2");
							}
						} else {
							erro_c++;
				...
				//EA13-가 수금테이블 조인시 미수가 있으면 EA13 파일 생성시 추가안됨.
				//즉, 해지신청 시 미수가 있으면 해지신청이 못들어가게 막음.
				resultList = generalDAO.getSqlMapClient().queryForList("billing.student.cmsrequest.getUserList2", dbparam);
				logger.debug("===== billing.student.cmsrequest.getUserList2");
				...
				if ( StringUtils.isNotEmpty(text) ) {
					...
					try {
						FileUtil.saveTxtFile(
								PATH_UPLOAD_RELATIVE_CMS_STU_EB13 + "/" + year.substring(0, 2) + rdate.substring(0, 2), 
				...
				if ( serialno == 0 ) {
					...
					generalDAO.getSqlMapClient().insert("billing.student.cmsrequest.insertEB13Log", dbparam);
					logger.debug("===== billing.student.cmsrequest.insertEB13Log");
			...
			mav.setViewName("billing/student/cmsrequest/process13b_stu");
			mav.addObject("now_menu", MENU_CODE_BILLING_STU);
			mav.addObject("show_hidden5", "display");
	 ...
	 * @throws Exception
	 */
	public ModelAndView process13c_stu(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		...
		Map resultMap = (Map) generalDAO.queryForObject("billing.student.cmsrequest.getEB13LogFirstRow", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEB13LogFirstRow");

		// mav
		ModelAndView mav = new ModelAndView();
		mav.setViewName("billing/student/cmsrequest/process13c_stu");
		mav.addObject("now_menu", MENU_CODE_BILLING_STU);
	...
	public ModelAndView index_stu(HttpServletRequest request,
		...
		// excute query
		List resultList = generalDAO.queryForList("billing.student.cmsrequest.getEB14LogList", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEB14LogList");
		
		int t_count = (Integer) generalDAO.queryForObject("billing.student.cmsrequest.getEB14LogCount", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEB14LogCount");
		
		// mav
		ModelAndView mav = new ModelAndView();
		mav.setViewName("billing/student/cmsrequest/index_stu");
		mav.addObject("now_menu", MENU_CODE_BILLING_STU);
		mav.addObject("show_hidden5", "display");
	...
	public ModelAndView view_stu(HttpServletRequest request,
		...
		int totals = (Integer) generalDAO.queryForObject("billing.student.cmsrequest.getEALogCount", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEALogCount");
		...
		dbparam.put("cmstype", "EA13+");
		dbparam.put("cmsdate", cmsdate);
		int noErrnum1 = (Integer) generalDAO.queryForObject("billing.student.cmsrequest.getEALogCount", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEALogCount");
		...
		dbparam.put("cmstype", "EA13+");
		dbparam.put("cmsdate", cmsdate);
		int Errnum1 = (Integer) generalDAO.queryForObject("billing.student.cmsrequest.getEALogCount", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEALogCount");
		...
		dbparam.put("cmstype", "EA13-");
		dbparam.put("cmsdate", cmsdate);
		int noErrnum2 = (Integer) generalDAO.queryForObject("billing.student.cmsrequest.getEALogCount", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEALogCount");
		...
		dbparam.put("cmstype", "EA13-");
		dbparam.put("cmsdate", cmsdate);
		int Errnum2 = (Integer) generalDAO.queryForObject("billing.student.cmsrequest.getEALogCount", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEALogCount");
		...
		List resultList = generalDAO.queryForList("billing.student.cmsrequest.getEALogList", dbparam);
		logger.debug("===== billing.student.cmsrequest.getEALogList");
		
		List jikukList = generalDAO.queryForList("billing.student.cmsrequest.getAgencyList", dbparam);
		...
		// mav
		ModelAndView mav = new ModelAndView();
		mav.setViewName("billing/student/cmsrequest/view_stu");
		mav.addObject("now_menu", MENU_CODE_BILLING_STU);
		mav.addObject("show_hidden5", "display");
	 ...
	 * @category 이체신청결과엑셀출력
	 */
	public ModelAndView viewExcel_stu(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		// param
		ModelAndView mav = new ModelAndView();
		...
		try{
			...
			String fileName = "resultAplcStuCMS_(" + DateUtil.getCurrentDate("yyyyMMdd") + ").xls";
			//Excel response
			response.setHeader("Content-Disposition", "attachment; filename=" + fileName); 
			response.setHeader("Content-Description", "JSP Generated Data");
			mav.setViewName("billing/student/cmsrequest/viewExcel_stu");
	...
	public ModelAndView input_db_stu(HttpServletRequest request,
		...
		if ( cmsfile.isEmpty()) {	// 파일 첨부가 안되었으면 
			...
			mav.addObject("returnURL", "/billing/student/cmsrequest/index_stu.do");
			return mav;
		}
		else {	// 파일 첨부가 되었으면
			...
			String strFile = fileUtil.saveUploadFile(
											cmsfile, 
											PATH_PHYSICAL_HOME,
											PATH_UPLOAD_ABSOLUTE_CMS_STU_EB14 + "/" + year
										);
			...
			if ( StringUtils.isEmpty(strFile) ) {
				...
				if ( "EB14".equals(fmt1) ) {
					...
					String fileName = PATH_UPLOAD_RELATIVE_CMS_STU_EB14 + "/" + year + "/" + strFile;
					...
					try {
						...
						while ((count = fis.read(b)) != -1) {
							...
							if ( txtline.length() != 0 ) {
								...
								if ( txt_code.equals(CODE_CMS_LAYOUT_HEADER)) {	// 헤더면
									...
									// excute query
									generalDAO.getSqlMapClient().update("billing.student.cmsrequest.updateEALog", dbparam);
									logger.debug("===== billing.student.cmsrequest.updateEALog");
									...
									// excute query
									generalDAO.getSqlMapClient().update("billing.student.cmsrequest.updateTblUsers", dbparam);
									logger.debug("===== billing.student.cmsrequest.updateTblUsers");
									...
									// excute query
									generalDAO.update("billing.zadmin.cmsrequest.updateTblUsers", dbparam);
									...
									*/
									...
									// excute query
									generalDAO.getSqlMapClient().insert("billing.student.cmsrequest.insertCmsEA14Data", dbparam);
									logger.debug("===== billing.student.cmsrequest.insertCmsEA14Data");
								}
									...
									// excute query
									generalDAO.getSqlMapClient().insert("billing.student.cmsrequest.insertCmsEA14DataResult", dbparam);
									logger.debug("===== billing.student.cmsrequest.insertCmsEA14DataResult");
								}
							}
						}
						...
						// excute query
						generalDAO.getSqlMapClient().update("billing.student.cmsrequest.updateTblUsers", dbparam);
						logger.debug("해지처리 ===== billing.student.cmsrequest.updateTblUsers");
						...
						// excute query
						generalDAO.getSqlMapClient().update("billing.student.cmsrequest.updateTblUsersError", dbparam);
						logger.debug("에러처리(신청시)===== billing.student.cmsrequest.updateTblUsersError");
						...
						// excute query
						generalDAO.getSqlMapClient().update("billing.student.cmsrequest.updateTblUsersError", dbparam);
						logger.debug("에러처리(해지시)===== billing.student.cmsrequest.updateTblUsersError");
						...
						// excute query
						generalDAO.getSqlMapClient().update("billing.student.cmsrequest.updateTblUsers", dbparam);
						logger.debug("신청시 ===== billing.student.cmsrequest.updateTblUsers");
				...
				mav.setViewName("billing/student/cmsrequest/input_db_stu");
				mav.addObject("now_menu", MENU_CODE_BILLING_STU);
